package com.ie1e.platformjstoweb.AliPay;
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            ...
                            MainActivity.mWebView.post(new Runnable() {
                                @Override
                                public void run() {
                                    MainActivity.mWebView.loadUrl("javascript:AliPayToJs('支付结果确认中')");
                                }
                            });
                            ...
                            MainActivity.mWebView.post(new Runnable() {
                                @Override
                                public void run() {
                                    MainActivity.mWebView.loadUrl("javascript:AliPayToJs('支付失败')");
                                }
                            });
                        }
                    }
